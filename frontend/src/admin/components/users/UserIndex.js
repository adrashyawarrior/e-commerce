                    ...
                    <tbody>
                        {
                            users.map((user, i) => {
                                return (
                                    <tr key={`user-${i}`} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className="py-4 px-6 flex items-center">
                                            <Link to={`/users/${user._id}/edit`} className="px-1 font-medium inline-block text-blue-600 dark:text-blue-500 hover:underline">
                                            ...
                                            <Link to="#" onClick={() => { deleteUser(user._id) }} className="px-1 inline-block font-medium text-blue-600 dark:text-blue-500 hover:underline">
