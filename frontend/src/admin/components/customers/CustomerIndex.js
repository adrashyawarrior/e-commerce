...
const CustomerIndex = () => {
    ...
    React.useEffect(() => {
        CustomerService.getCustomers(`?perPage=${perPage}&page=${currentPage}`).then((response) => {
        ...
        <div className='p-8'>
            <div className='grid grid-cols-2'>
                ...
                <div className='flex flex-row-reverse pb-4'>
                    <Link to="/customers/create" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <tbody>
                        {
                            customers.map((customer, i) => {
                                return (
                                    <tr key={`customer-${i}`} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className="py-4 px-6 flex items-center">
                                            ...
                                            <Link to="#" className="px-1 inline-block font-medium text-blue-600 dark:text-blue-500 hover:underline">
