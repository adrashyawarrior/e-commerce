    ...
    return (
        <div class="grid grid-cols-12 justify-between px-4 py-2 leading-normal items-center bg-gray-100 rounded-lg border shadow-md w-full mx-2 my-2">
            ...
            <div className="col-span-2">
                ...
                <button onClick={() => { addProductHandler() }} type="button" class="text-green-400 hover:text-green-600 font-medium rounded-lg text-sm"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
